...
output_root = 'C:/Uni3rd/thirdY/finalDB/outputsBG2'
...
images = glob.glob('C:/Uni3rd/thirdY/finalDB/afterEdit/*.png') + glob.glob('C:/Uni3rd/thirdY/finalDB/afterEdit/*.jpg')
...
for num_images in combinations:
    ...
    for i in range(num_outputs):
        ...
        img_bg = Image.open("background1.png").convert("RGBA")  # Load the custom background image and convert to RGBA mode
        img_bg = img_bg.resize((1000, 800))  # Resize the background image to the desired size
